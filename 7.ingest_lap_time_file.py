...
qualifying_schema = StructType(fields=[StructField("qualifyId", IntegerType(), False),
                                      ...
                                      StructField("numer", IntegerType(), True),
...
qualifying_df = spark.read \
    .schema(qualifying_schema) \
        .option("multiLine", True) \
            .json("/mnt/formula1dlcvtg/raw/qualifying")
...
final_df.write.mode("overwrite").parquet("/mnt/formula1dlcvtg/processed/qualifying")

# COMMAND ----------

display(spark.read.parquet("/mnt/formula1dlcvtg/processed/qualifying"))
